...
@Builder
@AllArgsConstructor
public class EventSimpleApiInfo {
    ...
    public static EventSimpleApiInfo from(EventSimpleInfo eventSimpleInfo) {
        return EventSimpleApiInfo.builder()
                .eventId(eventSimpleInfo.getEventId())
                .type(eventSimpleInfo.getType())
                .eventHostUserId(eventSimpleInfo.getEventHostUserId())
                .eventHostUserName(eventSimpleInfo.getEventHostUserName())
                .eventHostUserProfileImageUrl(eventSimpleInfo.getEventHostUserProfileImageUrl())
                .abstractLocation(eventSimpleInfo.getAbstractLocation())
                .currentHeadCount(eventSimpleInfo.getCurrentHeadCount())
                .maxHeadCount(eventSimpleInfo.getMaxHeadCount())
                .startDate(eventSimpleInfo.getStartDate())
                .endDate(eventSimpleInfo.getEndDate())
                .categories(eventSimpleInfo.getCategories())
                .build();
    }
}
