...
public interface PostCommentService {
    ...
    RegisterPostCommentChildResponse registerPostCommentChild(Long postCommentId, Long userId, PostCommentChildRegisterRequest postCommentChildRegisterRequest);
