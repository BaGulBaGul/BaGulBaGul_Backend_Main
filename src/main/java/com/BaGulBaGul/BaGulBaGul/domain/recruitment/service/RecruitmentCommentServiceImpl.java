...
public class RecruitmentCommentServiceImpl implements RecruitmentCommentService {
    ...
    public Long registerCommentChild(
        ...
        //대댓글 추가 후 결과를 받아옴
        RegisterPostCommentChildResponse result = postCommentService.registerPostCommentChild(commentId, authenticatedUserInfo.getUserId(), postCommentChildRegisterRequest);
    ...
    private void checkModifyPermission(AuthenticatedUserInfo authenticatedUserInfo, PostComment postComment) {
    ...
    private void checkModifyPermission(AuthenticatedUserInfo authenticatedUserInfo, PostCommentChild postCommentChild) {
