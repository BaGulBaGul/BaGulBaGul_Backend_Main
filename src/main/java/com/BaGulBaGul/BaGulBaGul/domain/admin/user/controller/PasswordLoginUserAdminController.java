...
@RestController
@RequestMapping("/api/admin/user/ampwuser")
...
public class PasswordLoginUserAdminController {
    ...
    public ApiResponse<AMPWUserRegisterApiResponse> registerAMPWUser(
            @RequestBody AMPWUserRegisterApiRequest ampwUserRegisterApiRequest
    ) {
    ...
    @Operation(summary = "관리자 관리 패스워드 로그인 유저 삭제")
