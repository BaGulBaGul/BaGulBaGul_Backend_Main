...
@RestController
@RequestMapping("/api/admin/user/{targetUserId}/roles")
...
public class UserRoleAdminController {
    ...
    public ApiResponse<Void> setUserRole(
            @AuthenticationPrincipal AuthenticatedUserInfo requestUserInfo,
            @PathVariable Long targetUserId,
            @RequestBody SetUserRoleApiRequest setUserRoleApiRequest
    ) {
        userRoleService.changeRole(requestUserInfo, targetUserId, setUserRoleApiRequest.getRoles());
    ...
    public ApiResponse<Void> addUserRole(
        ...
        userRoleService.addRoles(requestUserInfo, targetUserId, addUserRoleApiRequest.getRoles());
        return ApiResponse.empty();
    }
    ...
    public ApiResponse<Void> removeUserRole(
        ...
        userRoleService.addRoles(requestUserInfo, targetUserId, removeUserRoleApiRequest.getRoles());
        return ApiResponse.empty();
    }
}
