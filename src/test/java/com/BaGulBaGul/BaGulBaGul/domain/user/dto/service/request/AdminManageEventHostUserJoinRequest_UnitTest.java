...
public class AdminManageEventHostUserJoinRequest_UnitTest {
    @Nested
    @DisplayName("검증 테스트")
    class Validation {
        @Test
        @DisplayName("정상 동작")
        void shouldOk() {
            AdminManageEventHostUserJoinRequest eventHostUserRegisterRequest = AdminManageEventHostUserSample
