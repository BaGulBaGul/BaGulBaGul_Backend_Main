...
public class PostSample {
    ...
    public static final int IMAGE_MAX_LENGTH = 10;
    ...
    public static PostModifyRequest getNormalModifyRequest() {
    ...
    public static PostRegisterRequest getNormal2RegisterRequest(){
        return PostRegisterRequest.builder()
    ...
    public static PostModifyRequest getNormal2ModifyRequest() {
        return PostModifyRequest.builder()
                .title(PostSample.NORMAL2_TITLE)
                .content(PostSample.NORMAL2_CONTENT)
                .tags(PostSample.NORMAL2_TAGS)
